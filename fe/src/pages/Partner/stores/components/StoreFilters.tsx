...
import type { StoreStatus } from "../hooks/usePartnerStores";
...
const options = [
  ...
  { value: "ACTIVE", label: "Đang hoạt động", color: "green" as const },
  { value: "INACTIVE", label: "Ngừng hoạt động", color: "red" as const },
];
