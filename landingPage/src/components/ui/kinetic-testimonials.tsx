      ...
      >
        ...
        >
          ...
          <CardContent className="p-4 md:p-6 relative z-10">
            <p className="text-sm md:text-base mb-4 leading-relaxed transition-colors duration-300 text-white/90">
              "{testimonial.review}"
            </p>
...
const KineticTestimonial: React.FC<KineticTestimonialProps> = ({
  ...
  return (
    <section
      className={`py-12 md:py-12 transition-colors duration-300 ${className}`}
    >
      <div className="relative w-full py-8 md:py-20 flex flex-col items-center overflow-hidden px-4 md:px-6">
        <h2 className="text-2xl md:text-4xl font-bold text-center mb-4 bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent dark:text-white">
          {title}
        </h2>
